...
$dll = Join-Path $PSScriptRoot 'bin\Az.StorageDiscovery.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\Az.StorageDiscovery.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './Az.StorageDiscovery.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'Az.StorageDiscovery'
$examplesFolder = Join-Path $PSScriptRoot 'examples'
$null = New-Item -ItemType Directory -Force -Path $examplesFolder

Write-Host -ForegroundColor Green 'Creating cmdlets for specified models...'
$modelCmdlets = @(@{modelName="StorageDiscoveryScope"; cmdletName="New-AzStorageDiscoveryScopeObject"})
...
if($NoDocs) {
  ...
  $moduleDescription = 'Microsoft Azure PowerShell: StorageDiscovery cmdlets'
...
$formatPs1xml = Join-Path $PSScriptRoot './Az.StorageDiscovery.format.ps1xml'
...
if (-not $DisableAfterBuildTasks){
  ...
  $afterBuildTasksArgs = ConvertFrom-Json '{"SubModuleName":"Az.StorageDiscovery","ModuleRootName":"$(root-module-name)"}' -AsHashtable
