...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] GenerateReport=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/reports/{discoveryResourceName}/generateReport"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Description(@"A long-running resource action.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/reports/{discoveryResourceName}/generateReport", ApiVersion = "2025-06-01-preview")]
    public partial class NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportContent _body = new Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.GetReportContent();
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the ReportResource")]
        ...
        /// <summary>
        /// The queries to execute against Storage Discovery data.Format: Base64-encoded JSON object with structure:{"queries":[{"name":"queryName","query":"KQL
        /// query"}]}For query syntax and available tables, see: https://aka.ms/storageDiscoveryQuery
        /// </summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The queries to execute against Storage Discovery data.Format: Base64-encoded JSON object with structure:{\"queries\":[{\"name\":\"queryName\",\"query\":\"KQL query\"}]}For query syntax and available tables, see: https://aka.ms/storageDiscoveryQuery")]
        ...
        Required = true,
        ReadOnly = false,
        Description = @"The queries to execute against Storage Discovery data.Format: Base64-encoded JSON object with structure:{""queries"":[{""name"":""queryName"",""query"":""KQL query""}]}For query syntax and available tables, see: https://aka.ms/storageDiscoveryQuery",
        SerializedName = @"queries",
        PossibleTypes = new [] { typeof(string) })]
        public string[] Query { get => _body.Query?.ToArray() ?? null /* fixedArrayOf */; set => _body.Query = (value != null ? new System.Collections.Generic.List<string>(value) : null); }

        /// <summary>Backing field for <see cref="StorageDiscoveryWorkspaceInputObject" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IStorageDiscoveryIdentity _storageDiscoveryWorkspaceInputObject;

        /// <summary>Identity Parameter</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Identity Parameter", ValueFromPipeline = true)]
        [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Category(global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.ParameterCategory.Path)]
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IStorageDiscoveryIdentity StorageDiscoveryWorkspaceInputObject { get => this._storageDiscoveryWorkspaceInputObject; set => this._storageDiscoveryWorkspaceInputObject = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult">Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets.NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded Clone()
        {
            var clone = new NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded();
            ...
            clone.DiscoveryResourceName = this.DiscoveryResourceName;
            return clone;
        }
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.Events.DelayBeforePolling:
                    {
                        var data = messageData();
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspaceExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ReportGenerateReport' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (StorageDiscoveryWorkspaceInputObject?.Id != null)
                    {
                        this.StorageDiscoveryWorkspaceInputObject.Id += $"/reports/{(global::System.Uri.EscapeDataString(this.DiscoveryResourceName.ToString()))}";
                        await this.Client.ReportGenerateReportViaIdentity(StorageDiscoveryWorkspaceInputObject.Id, _body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        // try to call with PATH parameters from Input Object
                        if (null == StorageDiscoveryWorkspaceInputObject.SubscriptionId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StorageDiscoveryWorkspaceInputObject has null value for StorageDiscoveryWorkspaceInputObject.SubscriptionId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StorageDiscoveryWorkspaceInputObject) );
                        }
                        if (null == StorageDiscoveryWorkspaceInputObject.ResourceGroupName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StorageDiscoveryWorkspaceInputObject has null value for StorageDiscoveryWorkspaceInputObject.ResourceGroupName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StorageDiscoveryWorkspaceInputObject) );
                        }
                        if (null == StorageDiscoveryWorkspaceInputObject.StorageDiscoveryWorkspaceName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("StorageDiscoveryWorkspaceInputObject has null value for StorageDiscoveryWorkspaceInputObject.StorageDiscoveryWorkspaceName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, StorageDiscoveryWorkspaceInputObject) );
                        }
                        await this.Client.ReportGenerateReport(StorageDiscoveryWorkspaceInputObject.SubscriptionId ?? null, StorageDiscoveryWorkspaceInputObject.ResourceGroupName ?? null, StorageDiscoveryWorkspaceInputObject.StorageDiscoveryWorkspaceName ?? null, DiscoveryResourceName, _body, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DiscoveryResourceName=DiscoveryResourceName})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportResult
                var result = (await response);
                // response should be returning an array of some kind. +Pageable
                // nested-array / results / <none>
                WriteObject(result.Result, true);
            }
        }
    }
}