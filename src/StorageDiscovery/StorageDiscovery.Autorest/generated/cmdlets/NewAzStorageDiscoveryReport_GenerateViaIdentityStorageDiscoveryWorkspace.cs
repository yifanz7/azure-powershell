...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace", SupportsShouldProcess = true)]
    ...
    public partial class NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportContent _body;

        /// <summary>Request to get StorageDiscoveryWorkspace data from ADX</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Request to get StorageDiscoveryWorkspace data from ADX", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportContent) })]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IGetReportContent Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets.NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace Clone()
        {
            var clone = new NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace"
        /// /> cmdlet class.
        /// </summary>
        public NewAzStorageDiscoveryReport_GenerateViaIdentityStorageDiscoveryWorkspace()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (StorageDiscoveryWorkspaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ReportGenerateReportViaIdentity(StorageDiscoveryWorkspaceInputObject.Id, Body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReportGenerateReport(StorageDiscoveryWorkspaceInputObject.SubscriptionId ?? null, StorageDiscoveryWorkspaceInputObject.ResourceGroupName ?? null, StorageDiscoveryWorkspaceInputObject.StorageDiscoveryWorkspaceName ?? null, DiscoveryResourceName, Body, onOk, onDefault, this, Pipeline);
                    }
