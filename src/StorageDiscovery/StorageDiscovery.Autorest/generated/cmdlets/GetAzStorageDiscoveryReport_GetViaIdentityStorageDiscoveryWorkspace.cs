...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/reports/{discoveryResourceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzStorageDiscoveryReport_GetViaIdentityStorageDiscoveryWorkspace")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Description(@"Get a ReportResource")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Generated]
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/reports/{discoveryResourceName}", ApiVersion = "2025-06-01-preview")]
    public partial class GetAzStorageDiscoveryReport_GetViaIdentityStorageDiscoveryWorkspace : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource">Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource</see>
        /// from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAzStorageDiscoveryReport_GetViaIdentityStorageDiscoveryWorkspace" /> cmdlet
        /// class.
        /// </summary>
        public GetAzStorageDiscoveryReport_GetViaIdentityStorageDiscoveryWorkspace()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (StorageDiscoveryWorkspaceInputObject?.Id != null)
                    {
                        ...
                        await this.Client.ReportGetViaIdentity(StorageDiscoveryWorkspaceInputObject.Id, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ReportGet(StorageDiscoveryWorkspaceInputObject.SubscriptionId ?? null, StorageDiscoveryWorkspaceInputObject.ResourceGroupName ?? null, StorageDiscoveryWorkspaceInputObject.StorageDiscoveryWorkspaceName ?? null, DiscoveryResourceName, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Models.IReportResource
