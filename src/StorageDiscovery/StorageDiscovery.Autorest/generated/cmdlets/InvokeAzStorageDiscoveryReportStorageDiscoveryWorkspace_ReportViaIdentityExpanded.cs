...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Report=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/report"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.HttpPath(Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageDiscovery/storageDiscoveryWorkspaces/{storageDiscoveryWorkspaceName}/report", ApiVersion = "2025-06-01-preview")]
    public partial class InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Runtime.IContext
    {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageDiscovery.Cmdlets.InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded Clone()
        {
            var clone = new InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzStorageDiscoveryReportStorageDiscoveryWorkspace_ReportViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'StorageDiscoveryWorkspacesReport' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.StorageDiscoveryWorkspacesReportViaIdentity(InputObject.Id, _body, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.StorageDiscoveryWorkspacesReport(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.StorageDiscoveryWorkspaceName ?? null, _body, onOk, onDefault, this, Pipeline);
                    }
